ooooo<%@page import="java.io.File"%>
...
<center><h2>Summary of your article:-</h2></center>
	...
	<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
     ...
     <%
                                         CallApi ob1=new CallApi();
                           StringBuilder builder1=  ob1.getSummary("C://Users//Snehil Sharma//Desktop//QBS2//web//Documents//outss.txt");
 ...
 %>
        ...
        <form action="userHome.jsp" method="post">
               <input type="submit" class="btn btn-warning abc" value="Go back to user section!!">
        </form>

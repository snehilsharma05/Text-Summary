...
<title>Books Record :: This Month </title>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Books Added In <?php echo date("m"); ?></li>
			</ol>
		</div>		
		<div class="row">
			<!--xxxxx-->
...
$(document).ready(function()
{
	...
	({
		...
		type: 'post',
		data : "Action=recentMonthAddition",

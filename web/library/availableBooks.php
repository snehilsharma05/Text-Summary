...
<title>Available Books Record </title>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">All Available Books</li>
			</ol>
		</div>
		<div class="row">
			<div class="col-lg-12" >

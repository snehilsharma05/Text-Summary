...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">List of Approved Users</h1>
	...
	con=DriverManager.getConnection("jdbc:mysql://localhost:3306/project","root","root");
                        stmt=con.createStatement();
						  rs=stmt.executeQuery("select * from users where status='1' and role='2'");
						  while(rs.next())
						  {
							  %>
							  <tr>
							  ...
							  <input type="submit" class="btn btn-success" value="View"/>
                                                           ...
                                                           <td> 
							  <form action="declineUsers.jsp" method="post">
								 <input type="hidden" value="<%=rs.getString(1)%>" name="id"/>

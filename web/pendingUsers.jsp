...
<body>
	...
	<th>Age</th>
        ...
        <th>Click here to Approve</th>
        <th>Click Here to Decline</th>
	...
	con=DriverManager.getConnection("jdbc:mysql://localhost:3306/project","root","root");
					 ...
					 rs=stmt.executeQuery("select * from users where status='0' ");
						  while(rs.next())
						  {
							  %>
							  <tr>
							 ...
							 <input type="submit" class="btn btn-success" value="View"/>
                                                          ...
                                                          <td> 
							  <form action="AcceptUsers" method="post">
								 <input type="hidden" value="<%=rs.getString(1)%>" name="id"/>
							 ...
							 <input type="submit" class="btn btn-success" value="Accept"/>
                                                           ...
                                                           <td> 
							  <form action="DeclineUsers" method="post">
								 <input type="hidden" value="<%=rs.getString(1)%>" name="id"/>
							 <input type="hidden" value="<%=rs.getString(3)%>" name="email"/>

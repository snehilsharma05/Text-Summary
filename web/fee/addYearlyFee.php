	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 ">		
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Add Yearly Fees</li>
			</ol>
		</div>
		...
		<div class="row">
			<div class="login-panel panel panel-default">
				...
				<div class="panel-body">
					<form action="requestPages/Handle_requests.php" method="post" name="add_yearly_fee_form" id="add_yearly_fee_form">	
						<fieldset>
...
//only numeric
	...
	function sum()
	{
		...
		if(instalment=="First Instalment")
		{
			tution_charge=12*tution_charge;
			smart_class_charge=12*smart_class_charge;
		}
...
$(document).ready(function () 
{
		...
		if(adm.length >= 3)
		{
			...
			({
				...
				success : function(response)
				{
					...
					{	
						if(response.msg=="Full Fee Pending")
						{
							$("#notify").html(response.msg);
	...
	// submit form 
	$("#add_yearly_fee_form").on("submit",function(e)
	{
		e.preventDefault();
